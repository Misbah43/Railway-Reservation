...
class Train
{
    ...
    string quotas[5]={"GENERAL","LADIES","SENIOR CITIZEN","TATKAL","PREMIUM TATKAL"};
    string type;
    string quota;
    public:
    Train()
   ...
   Train(string n,int i,int p,int p1)
    {
        name=n;
        id=i;
        type=types[p-1];
...
class RajdhaniExpress : public Train
{
    ...
    RajdhaniExpress()
    {
     ...
     RajdhaniExpress(int p,string s1,string s2,int p1):Train("Rajdhani Express",22691,p,p1)
    {
        src=s1;
        dst=s2;
    }
    friend void fare(int p,int p1);
    void get()
    {
        display();
...
class NizamuddinExpress : public Train
{
    ...
    NizamuddinExpress()
    {
     ...
     NizamuddinExpress(int p,string s1,string s2,int p1):Train("Nizamuddin Express",17305,p,p1)
    {
        src=s1;
        dst=s2;
    }
    friend void fare(int p,string src,string des,int p1);
    void get()
    {
        display();
        cout<<"Source is - "<<src<<endl;
...
class ShatabdiExpress : public Train
{
    ...
    ShatabdiExpress()
    {
     ...
     ShatabdiExpress(int p,string s1,string s2,int p1):Train("Shatabdi Express",12009,p,p1)
    {
        src=s1;
        dst=s2;
    }
    friend float fare2(int p,int p1);
    void get()
    {
        display();
        cout<<"Source is - "<<src<<endl;
...
void fare(int p,string str,string des,int p1)
{
    float gst,amt;
    if(p==1)
    {
...
class DurontoExpress : public Train
{
    ...
    DurontoExpress()
    {
     ...
     DurontoExpress(int p,string s1,string s2,int p1):Train("Duronto Express",12293,p,p1)
    {
        src=s1;
        dst=s2;
    }
    void fare1(int p,int p1);
    void operator ++()
    {
        amt=amt+100;
...
void DurontoExpress:: fare1(int p,int p1)
{
    float gst;
    if(p==1)
    {
...
class VandeBharatExpress : public Train
{
    ...
    VandeBharatExpress()
    {
     ...
     VandeBharatExpress(int p,string s1,string s2,int p1):Train("Vande Bharat Express",22493,p,p1)
    {
        src=s1;
        dst=s2;
    }
     float fare(int p,int p1);
     void operator ++()
    {
        amt=amt+120;
        cout<<"New fare after food addition is  = "<<amt<<endl;
...
float VandeBharatExpress:: fare(int p,int p1)
{
    float gst;
    if(p==1)
    {
...
//friend function
void RE(int p,string src,string des,int p1)
{
     RajdhaniExpress re(p,src,des,p1);
    re.details();
    re.get();
    fare(p,p1);
}
//function overloading
void NE(int p,string src,string des,int p1)
{
     NizamuddinExpress ne(p,src,des,p1);
    ne.details();
    ne.get();
    fare(p,src,des,p1);
}
//function protopype
void SE(int p,string src,string des,int p1)
{
     ShatabdiExpress se(p,src,des,p1);
    se.details();
    se.get();
    float amt=fare2(p,p1);
    cout<<"Total fare is - "<<amt<<endl;
}
//function overriding and operator overloading
void DE(int p,string src,string des,int p1)
{
    int d;
     DurontoExpress de(p,src,des,p1);
    de.details();
    de.Train::display();
    de.display();
    de.fare1(p,p1);
...
void VBE(int p,string src,string des,int p1)
{
    int d;
    float d1;
     VandeBharatExpress vbe(p,src,des,p1);
     vbe.details();
     vbe.get();
      d1=vbe.fare(p,p1);
      cout<<"Total fare is - "<<d1<<endl;
       cout<<"Enter 1 if u want food"<<endl;
    cin>>d;
    if(d)
    {
                ...
                switch(n1)
                {
                    case 1:
                        ...
                        switch(n2)
                        {
                            ...
                            cin>>p;
                            cout<<"Enter whick quota "<<endl;
                            cout<<"1- General"<<endl;
                            cout<<"2- Ladies"<<endl;
                            cout<<"3- Senior Citizen"<<endl;
                            cout<<"4- Tatkal"<<endl;
                            cout<<"5- Premium Tatkal"<<endl;
                            cin>>p1;
